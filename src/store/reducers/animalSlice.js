...
const initialAnimals = [
  { 
    ...
    name: 'RagDoll', 
    color: 'Noir', 
    image: require('../../../assets/Animal/RagDoll/Ragdoll1.jpeg'),
  ...
  { 
    ...
    name: 'Siamois', 
    color: 'Beige', 
    image: require('../../../assets/Animal/Siamois/Siamois4.jpg'),
  ...
  { 
    ...
    name: 'Berger', 
    color: 'Marron', 
    image: require('../../../assets/Animal/Berger/Berger1.jpg'),
  ...
  { 
    ...
    name: 'Labrador', 
    color: 'Doré', 
    image: require('../../../assets/Animal/Labrador/Labrador1.jpg'),
  ...
  { 
    ...
    name: 'Perroquet', 
    color: 'Multicolore', 
    image: require('../../../assets/Animal/Perroquet/Perroquet1.jpg'),
  ...
  { 
    ...
    name: 'Aigle', 
    color: 'Verte', 
    image: require('../../../assets/Animal/Aigle/Aigle1.jpg'),
  ...
  { 
    ...
    name: 'Pur-sang', 
    color: 'Marron', 
    image: require('../../../assets/Animal/Pur-Sang/Pursang1.jpg'),
  ...
  { 
    ...
    name: 'Shetland', 
    color: 'Noir et blanc', 
    image: require('../../../assets/Animal/Shetland/Shetland1.jpg'),
  ...
  { 
    ...
    name: 'Angora', 
    color: 'Blanc', 
    image: require('../../../assets/Animal/Angora/Angora1.jpeg'),
  ...
  { 
    ...
    image: require('../../../assets/Animal/Belier/Belier1.jpg'),
  ...
  { 
    ...
    name: 'Lion', 
    color: 'Jaune', 
    image: require('../../../assets/Animal/Lion/Lion1.jpg'),
  ...
  { 
    ...
    image: require('../../../assets/Animal/Tigre/Tigre1.jpg'),
